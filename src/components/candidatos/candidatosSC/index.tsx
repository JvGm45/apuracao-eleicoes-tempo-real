...
import jorginho from "../../../imagens/govsc/jorginho.jpg"
import decio from "../../../imagens/govsc/decio.jpg"

function GovernadorSC() {
    ...
    function candidatos() {
        axios.get(`https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/sc/sc-c0003-e000546-r.json`).then((response) => {
    ...
    React.useEffect(() => {
        ...
        return (
            ...
            <div className={style.titulosGovernadores}>
                <h2 className={style.inicioDaPagina}>Candidatos a governador de Santa Catarina.</h2>
            ...
            <div>
            <img src={jorginho} className={style.imagemTamanhoErrado}></img>
            <p className={style.informacoes}>O candidato {post1}</p>
            <p className={style.informacoes}>Tem {Qv}% e {Qv3} votos</p>
            </div>
            
            <div>
            <img src={decio} className={style.imagemTamanhoErrado}></img>
