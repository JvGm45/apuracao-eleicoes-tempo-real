...
import wilson from "../../../imagens/govam/wilson.jpg"
import braga from "../../../imagens/govam/braga.jpg"

function GovernadorAM() {
    ...
    function candidatos() {
        axios.get(`https://resultados.tse.jus.br/oficial/ele2022/547/dados-simplificados/am/am-c0003-e000546-r.json`).then((response) => {
