...
import marilia from "../../../imagens/govpe/marilia.jpg"
import lyra from "../../../imagens/govpe/lyra.jpg"

function GovernadorPE() {
    ...
    function candidatos() {
        axios.get(`https://resultados.tse.jus.br/oficial/ele2022/546/dados-simplificados/pe/pe-c0003-e000546-r.json`).then((response) => {
    ...
    React.useEffect(() => {
        ...
        return (
            ...
            <div className={style.titulosGovernadores}>
                <h2 className={style.inicioDaPagina}>Candidatos a governador de Pernambuco.</h2>
            ...
            <img src={marilia} className={style.imagemTamanhoErrado}></img>
            <p className={style.informacoes}>O candidato {post1}</p>
            <p className={style.informacoes}>Tem {Qv}% e {Qv3} votos</p>
            </div>
            
            <div className={style.divisaoCandidatos}>
            <img src={lyra} className={style.imagemTamanhoErrado}></img>
